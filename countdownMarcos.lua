...
function add_10minutes(activating)
	if activated == activating then
		return
	end
...
function add_time_button_clicked(props, p)
	add_timeM(true)
	return false
end
...
function script_properties()
	...
	obs.obs_properties_add_button(props, "add_10minutes", "Add time", add_time_button_clicked)
...
function script_load(settings)
	...
	--Noob try of copying functionality to add button 10 minutes add to the countdown timer
	id_add_time = obs.obs_hotkey_register_frontend("id_add_timer_marcos", "Add time", add_10minutes)
	local obs_hotkey_addtime = obs.obs_data_get_array (settings, "addtimeMarcos_hotkey")
	obs.obs_hotkey_load(id_add_time, hotkey_addtimemarcos)
	obs.obs_data_array_release(hotkey_addtimemarcos)
